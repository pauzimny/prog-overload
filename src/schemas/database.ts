...
export const roundInsertSchema = roundSchema.omit({ id: true, created_at: true })
export const roundUpdateSchema = roundSchema.partial().omit({ id: true, created_at: true })
...
export const trainingInsertSchema = trainingSchema.omit({ 
  id: true, 
  created_at: true, 
  updated_at: true,
  exercises: true 
